...
public class HU11Test {
    ...
    @Test
    public void testCancelarApartado_Exito() {
        Integer idBoleto = 1;
        ...
        boletoActualizado.setEstado(BOLETOESTADO.LIBRE);
        ...
        assertEquals(BOLETOESTADO.LIBRE, resultado.getEstado());
        verify(boletosDAO, times(1)).existsById(idBoleto);
        verify(boletosDAO, times(1)).save(boletoActualizado);
    }

    @Test
    public void testCancelarApartado_BoletoNoExiste() {
        Integer idBoleto = 2;
        Boleto boletoActualizado = new Boleto();
        boletoActualizado.setNumeroBoleto(idBoleto);
        boletoActualizado.setEstado(BOLETOESTADO.LIBRE);
